    ...
    <>
      ...
      <main className="p-1 w-full md:w-full px-4 md:px-10 2xl:px-32">
        ...
        <SafeImage
          ...
          width={1800}
          height={1200}
          className="sm:w-full h-[450px] sm:h-[500px] 2xl:h-[850px] rounded-4xl sm:mb-4 mt-4 object-cover"
          unoptimized
        />
        ...
        {data.validationTitle && (
          <section id="validation" className="scroll-mt-36 sm:mt-4 mt-10">
            ...
            <SafeImage
              ...
              width={1900}
              height={600}
              className="sm:w-full h-[450px] sm:h-[450px] rounded-4xl sm:mb-4 mt-4 object-cover"
            />
          ...
          <section id="conclusion" className="scroll-mt-36 sm:mt-10 mt-10">
            ...
            <div className="flex flex-col md:flex-row items-center sm:gap-10 sm:mt-4 sm:mx-20 my-4">
              <SafeImage
                ...
                width={600}
                height={600}
                className="rounded-4xl h-[450px] object-cover sm:w-full sm:h-full"
              />
