...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Macnman", url: "https://macnman.com/success-stories" }],
  keywords: [
  ...
  openGraph: {
    type: "website",
    siteName: "Macnman",
    url: "https://macnman.com/success-stories/",
    ...
    images: [
      {
        url: "https://macnman.com/success-stories/seo_homepage.png", // After deploy URL look like this
        width: 1200,
        height: 630,
    ...
    videos: [
      {
        url: "https://macnman.com/success-stories/landing_page_1.webm",
        width: 1280,
        height: 720,
      },
    ],
  ...
  twitter: {
    ...
    images: ["https://macnman.com/success-stories/seo_homepage.png"],
  },
