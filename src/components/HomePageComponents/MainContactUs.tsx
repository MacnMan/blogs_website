  ...
  return (
    <section id='contact' className="scroll-mt-24 min-h-screen mt-10">
      ...
      <div className="hidden md:block mb-8">
        <p
          className={`md:text-3xl lg:text-4xl font-bold text-center ${
            theme === "dark" && "text-white"
          }`}
        >
      ...
      <div className="md:hidden mb-8 text-center font-bold text-[26px]">
        <p
          className={`${
            theme === "dark" ? "text-white" : "text-[var(--heading-gray-color)]"
          }`}
        >
        ...
        <p
          className={`${
            theme === "dark" ? "text-white" : "text-[var(--text-color-primary)]"
          }`}
        >
          Reach Out Now
        </p>
      ...
      <div className="hidden max-w-xl lg:max-w-6xl md:flex md:flex-col lg:flex-row lg:justify-between lg:items-start lg:gap-6 mx-auto mt-8">
        <div className="lg:w-2/4 p-4">
          <div className="">
            <p
              className={`text-3xl md:text-5xl font-semibold text-center sm:text-start mb-4 ${
                theme === "dark"
                  ? "text-white"
            ...
            <div className="w-1/2   ">
              ...
              <div className="flex gap-4 text-3xl">
                <a href="https://youtube.com/@macnman_yt?si=uUOFsMQpQ3iGBj2F">
                  <FaYoutube className={`hover:text-[#FF0000] transition-colors duration-200 cursor-pointer ${
                  theme === "dark" && "text-white" }`}/>
                </a>
                <a href="https://www.linkedin.com/company/macnman/">
                  <FaSquareXTwitter className={`cursor-pointer ${
                  theme === "dark" && "text-white hover:text-black" }`} />
                </a>
                <a href="https://www.linkedin.com/company/macnman/">
        ...
        {/* Message Form */}
        <div
      className={`lg:w-1/2 p-12 rounded-3xl mt-4 lg:mt-0 ${
        theme === 'dark'
          ? 'bg-[#252525]'
    ...
    >
      <p
        className={`text-3xl md:text-4xl lg:text-5xl font-semibold text-start mb-4 ${
          theme === 'dark'
            ? 'text-white'
            : 'text-[var(--heading-gray-color)]'
        }`}
