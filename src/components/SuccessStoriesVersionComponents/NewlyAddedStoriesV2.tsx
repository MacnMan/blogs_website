...
// ✅ GROQ query to fetch latest 5 success stories (V2 collection)
export const newlyAddedV2Query = groq`
  *[_type == "successStoryV2"] | order(publishedAt desc)[0...5] {
    _id,
    title,
    slug {
      current
...
// ✅ Newly Added Section (V2)
export default function NewlyAddedStoriesV2({ stories }: { stories: SuccessStoryV2[] }) {
  ...
  return (
    <section className="rounded-3xl my-2 px-8 sm:px-4">
      <h2 className="sm:text-3xl text-xl font-semibold sm:mb-8 mb-4">
        Newly Added
      </h2>
